...
function descargarFotos(mision){
	console.log("descargarFotos");
	

	$.ajax({
	    method: 'GET',
	    url: '/api/versihayfotos/'+mision,
		  	...
		  	.done(function( msg ) {
			  	...
			  	if(msg['ok'] == true){
			  		new Noty({
						...
						layout: 'topRight',
						theme: 'mint',
						text: 'Las fotos se descargaran en breve',
						timeout: 10000,
						progressBar: true,
			  		...
			  		window.location.href = '/api/descargar/'+msg['nombre'];
			  	} else {
			  		console.log(inst);
				    inst.close();
			  		new Noty({
						...
						layout: 'topRight',
						theme: 'mint',
						text: 'Hubo un error al descargar el archivo: ' + msg['nombre'] ,
						timeout: 10000,
						progressBar: true,
						closeWith: ['click', 'button'],
						animation: {
...
function borrarFotos(mision){
	console.log("borrar");

	$.ajax({
	    method: 'GET',
	    url: '/api/borrarfotos/'+mision,
	    contentType : 'application/json',
	    error: function(data){
	  		inst.close();
        }
  	...
  	.done(function( msg ) {
	  	...
	  	if(msg['ok'] == true){
	  		new Noty({
				...
				layout: 'topRight',
				theme: 'mint',
				text: 'Se borraron todas las fotos de la mision',
				timeout: 10000,
				progressBar: true,
				closeWith: ['click', 'button'],
				animation: {
		    ...
		    form.action = "listadofotos";
		    form.method = "POST";
		    var input = document.createElement("input");
		    input.type = "hidden";
		    input.name = "mision";
		    input.value = document.getElementById("mision").value;
...
$(document).ready(function (){
	console.log(jQuery("#mision"));
	jQuery("#mision").select2();
});
