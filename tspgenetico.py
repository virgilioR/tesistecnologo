...
class City:
   def __init__(self, x=None, y=None, h=None, tipo=None):
      self.x = None
      self.y = None
      self.h = h
      self.tipo=tipo
   ...
   def damela(self):
      return [self.getX(),self.getY(),self.h,self.tipo]
...
class Tour:
   ...
   def damela(self):
	...
	for i in range(0, self.tourSize()):
		salida.append(self.getCity(i).damela())
	return salida	
	#print "chau"
...
if __name__ == '__main__':
   ...
   estacas=[[0,0,5.0,0],[6.16, 10.23, 5.0, 0], [15.5, 6.49, 5.0, 0], [13.98, -4.78, 5.0, 0],
           [-1.31, -15.49, 5.0, 0], [10.43, -18.77, 5.0, 0], [22.07, -21.72, 5.0, 0], [27.14, -10.34, 5.0, 0],
           [41.06, -11.9, 5.0, 0], [45.68, 1.35, 5.0, 0], [32.27, 4.23, 5.0, 0]]

   #reajustar donde esta la primera
   #print len(estacas)
